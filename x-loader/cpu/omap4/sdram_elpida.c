...
//	__raw_writel(0xFF020100, DMM_BASE + DMM_LISA_MAP_1);
	...
	__raw_writel(0x0, DMM_BASE + DMM_LISA_MAP_3);
	__raw_writel(0x0, DMM_BASE + DMM_LISA_MAP_2);
	__raw_writel(0x0, DMM_BASE + DMM_LISA_MAP_1);
	__raw_writel(0x0, DMM_BASE + DMM_LISA_MAP_0);

	__raw_writel(0x80640300, DMM_BASE + DMM_LISA_MAP_3);
	__raw_writel(0x0, DMM_BASE + DMM_LISA_MAP_2);
	__raw_writel(0x0, DMM_BASE + DMM_LISA_MAP_1);
	__raw_writel(0xff020100, DMM_BASE + DMM_LISA_MAP_0);
...
//		__raw_writel(0x80640300, DMM_BASE + DMM_LISA_MAP_3);
		...
		__raw_writel(0x00000000, MA_BASE + DMM_LISA_MAP_1);
		__raw_writel(0xff020100, MA_BASE + DMM_LISA_MAP_0);
	}
